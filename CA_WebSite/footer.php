          ...
          <div class="row">
            ...
            <div class="col-lg-3 col-md-5 ms-footer-col ms-footer-text-right">
              <div class="ms-footbar-block">
                ...
                <address class="no-mb">
                  <p>
                    <a href="https://goo.gl/maps/XVqxZxbwtvp" target="_blank"><i class="color-danger-light zmdi zmdi-pin mr-1"></i></a>C2-18, 2nd Floor,Brahma Commercial Plaza,<br />NIBM Junction,Pune
                    
                  </p>
                  <p>
                    <i class="color-warning-light zmdi zmdi-map mr-1"></i>India - UAE - Malaysia</p>
                  <p>
